...
from .ranker import calculate_match_score, rank_entities
from .tools import filter_by_constraints, search_entities
...
def draft_outreach(requirement, recommendations: list[Recommendation]) -> str:
...
def run_agent(request: str, inject_invalid_first: bool = False) -> AgentResponse:
    ...
    ranked = rank_entities(valid_entities, requirement)
